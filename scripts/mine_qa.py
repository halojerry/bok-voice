...
# --cluster 纯函数已上移 bok_voice_core.qa_cluster(2026-09-19 W3-T1,CP 端点
# 同源共用);此处 re-export 保持 CLI 旧名/旧调用点零变化(测试钉住这些名字)。
from bok_voice_core.qa_cluster import (  # noqa: E402
    _CLUSTER_SYSTEM_PROMPT,
    parse_llm_decisions as _parse_llm_decisions,
    plan_cluster,
)
