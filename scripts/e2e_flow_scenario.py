...
async def main() -> None:
    ...
    steps = [
        ...
        # 收号码步方向铁律(2026-09-14 call-c76832ac 实证):必须向客户索取客户自己的微信号，
        # 旧稿「我发微信号俾你」是反方向——客户永远不报号码、步锁死，且与 agent 收号码逻辑自相矛盾。
        {"goal": "向客户索取微信号，引导通过微信消费者保护线上专员办理", "ref": "理赔係通过微信消费者保护线上专员办理，麻烦你将你嘅微信号报俾我，微信专员会加你，按佢步骤操作办理就得"},
    ]
