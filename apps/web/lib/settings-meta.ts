...
export const SETTING_CARDS: ProviderMeta[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "speaker_zh", label: "普通话音色", type: "text", preview: true, advanced: true, hint: "「按语言分音色」模式的普通话音色；「整场同声」模式下仅当默认音色留空时回落。留空时普通话通话默认克隆音色 moss（moss_audio_aaa1346a…）。", placeholder: "如 moss_audio_aaa1346a-7ce7-11f0-8e61-2e6e3c7ee85d" },
